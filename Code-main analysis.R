...
#This file is a supplement to the paper "Loneliness and cognitive function in older adults: longitudinal analysis in 15 countries" by Cachon-Alonso et al. (2023). It contains the code used to conduct the main analysis included in the paper in following order:
#1. Modelling steps
#2. Multiple group RICLPM
#3. RICLPM adjusted for confounders
#Our analysis were conducted with lavaan (Rosseel, 2012) following the coding steps proposed by Mulder and Hamaker (2021)  https://jeroendmulder.github.io/RI-CLPM/lavaan.html
...
#Here, we show as an example the code for the models exploring the associations between verbal fluency and the three-item measure of loneliness. All the other models followed the same structure.

## 1.Modelling steps: constrained vs. grand means constrained; unconstrained vs. constrained model
